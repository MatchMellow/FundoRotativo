...
public class PessoaController {
    ...
    public Button getCadastrarVoluntarioButton() {
        return cadastrarVoluntarioButton;
    }

    public void setCadastrarVoluntarioButton(Button cadastrarVoluntarioButton) {
        this.cadastrarVoluntarioButton = cadastrarVoluntarioButton;
    }

    public Button getVisualizarSolicitanteButton() {
        return visualizarSolicitanteButton;
    }

    public void setVisualizarSolicitanteButton(Button visualizarSolicitanteButton) {
        this.visualizarSolicitanteButton = visualizarSolicitanteButton;
    }

    public Button getVisualizarVoluntarioButton() {
        return visualizarVoluntarioButton;
    }

    public void setVisualizarVoluntarioButton(Button visualizarVoluntarioButton) {
        this.visualizarVoluntarioButton = visualizarVoluntarioButton;
    }
}
