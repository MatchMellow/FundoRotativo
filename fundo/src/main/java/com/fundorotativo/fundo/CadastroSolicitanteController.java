...
public class CadastroSolicitanteController {
    ...
    private void onCadastrarClick(ActionEvent event) {
        ...
        // Criar e salvar o solicitante no arquivo
        Solicitante solicitante = new Solicitante(nome, cpf, rg, endereco, bairro);
        ArquivoHandler.salvarSolicitante(solicitante);

        // Exibir mensagem de sucesso
        Alert alert = new Alert(Alert.AlertType.INFORMATION);
        alert.setTitle("Cadastro realizado");
        alert.setHeaderText("Solicitante cadastrado com sucesso!");
        alert.showAndWait();
