...
public class Fachada {
    ...
    protected void onPessoaButtonClick() throws IOException {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/com/fundorotativo/fundo/pessoa-view.fxml"));  // Caminho corrigido
        Parent root = fxmlLoader.load();
        Scene scene = new Scene(root, 400.0F, 400.0F);

        if (this.primaryStage == null) {
            this.primaryStage = new Stage();  // Cria uma nova janela caso o primaryStage seja null
        }
        this.primaryStage.setScene(scene);  // Define a cena no primaryStage
    ...
    protected void onEmprestimosButtonClick() throws IOException {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/com/fundorotativo/fundo/emprestimos-view.fxml")); // Caminho corrigido
        Parent root = fxmlLoader.load();
        Scene scene = new Scene(root, 600.0F, 700.0F);  // Ajuste o tamanho conforme necessário
    ...
    protected final void onRelatoriosButtonClick() throws IOException {
        ...
        Parent root = fxmlLoader.load();
        Scene scene = new Scene(root, 400.0F, 200.0F);  // Ajuste o tamanho conforme necessário
